...
### Fixed
- Removed duplicate MapStruct mapper stubs from `com.unikly.jobservice.api.mapper` that conflicted with canonical mappers in `com.unikly.jobservice.application.mapper`
- Consolidated Flyway migrations from 4 files (V1–V4) to canonical 2-file structure: V1 (jobs, proposals, contracts, outbox_events) and V2 (processed_events)
- Restored correct package structure (`com.unikly.jobservice.*`) by eliminating files generated by incorrect prompts
