...
public interface PaymentRepository extends JpaRepository<Payment, UUID> {
    ...
    List<Payment> findByJobIdAndStatus(UUID jobId, com.unikly.paymentservice.domain.model.PaymentStatus status);
    ...
    java.math.BigDecimal sumVolumeByStatuses(@org.springframework.data.repository.query.Param("statuses") List<com.unikly.paymentservice.domain.model.PaymentStatus> statuses);
}
