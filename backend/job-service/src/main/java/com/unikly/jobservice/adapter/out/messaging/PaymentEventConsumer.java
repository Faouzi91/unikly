...
public class PaymentEventConsumer {
    ...
    public void handlePaymentCompleted(PaymentCompletedEvent event) {
        ...
        if (!acceptedProposals.isEmpty()) {
            ...
            var contract = com.unikly.jobservice.domain.model.Contract.builder()
                    .jobId(job.getId())
    ...
    private void publishStatusChangedEvent(com.unikly.jobservice.domain.model.Job job, JobStatus previousStatus) {
        try {
