package com.unikly.jobservice.common.adapter.out.messaging;
...
import com.unikly.jobservice.outbox.adapter.out.persistence.ProcessedEventRepository;
...
public class PaymentEventConsumer {
    ...
    public void handlePaymentCompleted(PaymentCompletedEvent event) {
        ...
        if (!acceptedProposals.isEmpty()) {
            ...
            var contract = com.unikly.jobservice.contract.domain.model.Contract.builder()
                    .jobId(job.getId())
    ...
    private void publishStatusChangedEvent(com.unikly.jobservice.job.domain.model.Job job, JobStatus previousStatus) {
        try {
