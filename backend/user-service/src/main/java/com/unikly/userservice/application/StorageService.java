...
public class StorageService {
    ...
    /**
     * Uploads a profile avatar image. Returns the public URL.
     */
    public String uploadAvatar(UUID userId, MultipartFile file) {
        validateImage(file);
        String key = "avatars/" + userId + "/" + UUID.randomUUID() + getExtension(file);
    ...
    private void validateDocument(MultipartFile file) {
        ...
        if (!ALLOWED_DOC_TYPES.contains(file.getContentType())) {
            throw new ResponseStatusException(HttpStatus.BAD_REQUEST, "Only PDF and Word documents are allowed");
        }
