...
> **Last updated:** Step 2.3 — Job Service Event Consumption
...
│           /api/search/** → search-service:8087 (planned)                    │
...
┌──────────────┐       ┌──────────────┐       ┌──────────────┐
│              │       │              │       │              │
│  JOB SERVICE │       │   KAFKA      │       │ USER SERVICE │
│              │       │              │       │              │
│  ┌────────┐  │       │ ┌──────────┐ │       │  ┌────────┐  │
│  │ Outbox  │──┼──────►│ job.events │◄┼───────┼──│ (reads)│  │
│  │Publisher│  │       │ └──────────┘ │       │  └────────┘  │
│  └────────┘  │       │              │       │              │
│              │       │ ┌──────────┐ │       │  ┌────────┐  │
│  ┌────────┐  │       │ │ user     │ │       │  │ Outbox  │  │
│  │(future)│◄─┼───────┤ │ .events  │◄┼───────┼──│Publisher│  │
│  └────────┘  │       │ └──────────┘ │       │  └────────┘  │
│              │       │              │       │              │
│  ┌────────┐  │       │ ┌──────────┐ │       │              │
│  │Payment │  │       │ │ payment  │ │       │              │
...
|--------------------|------------|-------------------|-----------------------------|
| `job.events`       | 6          | Job Service       | _(Search Service — planned)_|
| `user.events`      | 4          | User Service      | _(Search Service — planned)_|
